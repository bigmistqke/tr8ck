...
interface FaustCompilationSucces {
  success: true;
  dsp: TCompiledDsp;
}
interface FaustCompilationError {
  success: false;
  error: string;
}
export type FaustCompilationResponse =
  | FaustCompilationSucces
  | FaustCompilationError;
...
export type CompositionBlockProps =
