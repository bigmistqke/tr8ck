...
export async function setupAudio(/* onPitchDetectedCallback : Setter<number> */) {
  ...
  /*  try {
    ...
    const response = await window.fetch("public/wasm-audio/wasm_audio_bg.wasm");
    const wasmBytes = await response.arrayBuffer();

    // Add our audio processor worklet to the context.
    const processorUrl = "public/PitchProcessor.js";
    try {
